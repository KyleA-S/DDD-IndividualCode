...
namespace DDD
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                var seed = new SeniorTutor { Username = "admin", Name = "Senior Admin", Password = "admin123" };
                ...
                try
                {
                    switch (choice)
                    {
                        case 1:
                            ...
                            MenuHelper.StudentMenu(student, studentService, meetingService, wellbeingService, messageService, repo);
                            break;
                        ...
                        case 2:
                            ...
                            Console.WriteLine($"\n✔ Welcome {ps.Name}!");
                            InputHelper.PressEnterToContinue();
                            MenuHelper.PersonalSupervisorMenu(ps, psService, meetingService, wellbeingService, messageService, repo);
                            break;
                        ...
                        case 3:
                            ...
                            Console.WriteLine($"\n✔ Welcome {st.Name}!");
                            InputHelper.PressEnterToContinue();
                            MenuHelper.SeniorTutorMenu(st, stService, repo, messageService);
                            break;
